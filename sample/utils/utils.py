...
class Loader:
    ...
    Args:
        ...
        steps    (list, optional)  : List of strings for animating.
                                     Defaults to ["⢿", "⣻", "⣽", "⣾", "⣷", "⣯", "⣟", "⡿"]
        steptime (float, optional) : Sleep time between prints. Defaults to 0.1s.
    '''
    def __init__(
        self, desc="Loading...", end="Done!",
        steps=["⢿", "⣻", "⣽", "⣾", "⣷", "⣯", "⣟", "⡿"], steptime=0.1
    ):
        self.desc = desc
        self.end = end
...
def parameter_parser():
    ...
    # region: model hyperparmeters
    parser.add_argument(
        "--conv_hid_dim",
        type=int,
        default=3,
        help="Number of filters used in Conv",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help="Dimension of hidden vector between two Linear",
    )
